unit financas.model.contratoparcela;
...
uses
     ...
     /// orm
     financas.model.contrato, ormbr.types.blob, ormbr.types.lazy, ormbr.types.mapping, ormbr.types.nullable, ormbr.mapping.Classes, ormbr.mapping.register, ormbr.mapping.attributes;

type
     [Entity]
     [Table('ContratoParcela', '')]
     [PrimaryKey('IDCONTRATO;PARCELA', 'Chave primária')]
     [Indexe('idx_contratoparcela_parcela', 'PARCELA')]
     [OrderBy('PARCELA')]
